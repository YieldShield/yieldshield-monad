// Generated by scripts/generate-evm-abis.mjs from ProtectorReceiptNFT.sol/ProtectorReceiptNFT.json — do not edit by hand.
export const protectorReceiptNftAbi = [
  {
    type: "constructor",
    inputs: [
      {
