...
Subsequent verification: [the full deployment recheck](VERIFICATION_2026-09-15.md) identified and fixed the captured RPC rate-limit failure and several wallet/quote edge cases. It supersedes the earlier unresolved-cause note above, while retaining the actual-wallet testing limits.
