...
import { FactoryProxyTestBase } from "./BaseFactoryProxyTestBase.sol";
...
contract BaseSplitRiskPoolFactoryTest is Test, FactoryProxyTestBase {
    ...
    function setUp() public {
        ...
        SplitRiskPool poolImpl = SplitRiskPool(payable(BaseModuleTestDeploy.pool(vm)));
    ...
    function testSetPoolImplementationValidatesUUPSImplementation() public {
        ...
        SplitRiskPool newImplementation = SplitRiskPool(payable(BaseModuleTestDeploy.pool(vm)));
        vm.prank(governanceTimelock);
        vm.expectRevert(ErrorsLib.InvalidAssetAddress.selector);
