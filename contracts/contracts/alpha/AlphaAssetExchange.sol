...
import { AlphaAssetOracle } from "./AlphaAssetOracle.sol";
...
contract AlphaAssetExchange is ReentrancyGuard {
    ...
    AlphaAssetOracle public immutable oracle;
    ...
    constructor(address oracle_) {
        _requireDemoChain();
        if (oracle_.codehash != keccak256(type(AlphaAssetOracle).runtimeCode)) revert InvalidOracle();
        oracle = AlphaAssetOracle(oracle_);
