...
/// @title MockSteakhouseUSDC
/// @notice Mock implementation of the Steakhouse High Yield Instant Morpho vault
/// @dev Simulates ERC4626 vault behavior with time-based yield accrual
///      Real vault: https://app.morpho.org/ethereum/vault/0xbEeFf89ABb7815cCD5182BD1FF82C4a4F8FCb13D
contract MockSteakhouseUSDC is ERC4626, Ownable {
    using Math for uint256;

    /// @notice Timestamp of last yield accrual
    uint256 public lastYieldAccrualTime;

    /// @notice Annual yield in basis points (e.g., 1000 = 10% APY)
    ...
    /// @param _annualYieldBps Annual yield in basis points (e.g., 1000 = 10%)
    constructor(IERC20 _usdc, uint256 _annualYieldBps)
        ERC4626(_usdc)
        ERC20("Steakhouse High Yield USDC", "steakUSDC")
        Ownable(msg.sender)
    {
    ...
    function convertToAssets(uint256 shares) public view override returns (uint256) {
        ...
        // steakUSDC has 18 decimals, USDC has 6 decimals
    ...
    function convertToShares(uint256 assets) public view override returns (uint256) {
        ...
        // USDC has 6 decimals, steakUSDC has 18 decimals
