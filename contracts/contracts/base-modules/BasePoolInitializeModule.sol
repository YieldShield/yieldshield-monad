...
contract BasePoolInitializeModule is Initializable, ISplitRiskPool, ProtocolAccessControlUpgradeable, UUPSUpgradeable {
     ...
     */
    function getUtilizationRatio() public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
    ...
    function getProtectorPositionAmount(uint256 tokenId) public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }

    /// @notice Returns backing that belongs to an expired protector epoch and must be claimed separately.
    function getExpiredProtectorBackingClaim(uint256 tokenId) public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
    ...
    function requiresStrictProtectedBackingPrice() public view override returns (bool) { revert BaseModuleSelectorUnavailable(); }
    ...
    function refreshStrictProtectedBackingPriceFlag() external onlyGovernance { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function getUtilizationRatioUsd() public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function getLockedAmount(uint256 tokenId) public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function getAvailableForWithdrawal(uint256 tokenId) public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function getReservedFees() public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function getWithdrawableBalance() public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
     ...
     * @custom:error InsufficientTokenBalance If pool has insufficient balance
     */
    function payPoolFee() external nonReentrant whenNotPaused { revert BaseModuleSelectorUnavailable(); }
    ...
    function setPoolFeeRecipient(address newRecipient) external { revert BaseModuleSelectorUnavailable(); }
     ...
     * @custom:error InsufficientTokenBalance If pool has insufficient balance
     */
    function payProtocolFee() external nonReentrant whenNotPaused { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function claimCommission(uint256 tokenId) external nonReentrant { revert BaseModuleSelectorUnavailable(); }
     ...
     * @param tokenId The protector NFT token ID
     */
    function forfeitCommission(uint256 tokenId) external nonReentrant { revert BaseModuleSelectorUnavailable(); }
     ...
     * @param tokenId The protector NFT token ID
     */
    function settleExpiredProtectorPosition(uint256 tokenId) external nonReentrant whenNotPaused { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function getClaimableCommission(uint256 tokenId) public view returns (uint256) { revert BaseModuleSelectorUnavailable(); }
    ...
    ) external nonReentrant whenNotPaused onlyShieldNFTOwner(tokenId) returns (uint256 newTokenId) { revert BaseModuleSelectorUnavailable(); }

    function startUnlockProcess(uint256 tokenId) external nonReentrant onlyProtectorNFTOwner(tokenId) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function cancelUnlockProcess(uint256 tokenId) external nonReentrant onlyProtectorNFTOwner(tokenId) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function claimRewards(uint256 tokenId) external nonReentrant whenNotPaused { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function isAssetSupported(address asset) external view returns (bool supported) { revert BaseModuleSelectorUnavailable(); }
    ...
    function getUserNFTCounts(address user) external view returns (uint256 shieldNFTCount, uint256 protectorNFTCount) { revert BaseModuleSelectorUnavailable(); }
    ...
    function setShieldTransferLockPeriod(uint256 newPeriod) external onlyGovernance { revert BaseModuleSelectorUnavailable(); }

    /// @notice Updates the protector NFT transfer lock period
    /// @dev Only callable by governance timelock.
    /// @param newPeriod New transfer lock period in seconds
    function setProtectorTransferLockPeriod(uint256 newPeriod) external onlyGovernance { revert BaseModuleSelectorUnavailable(); }
    ...
    function setGovernanceTimelockFromFactory(address newGovernanceTimelock) external override { revert BaseModuleSelectorUnavailable(); }

    /// @notice Completes the two-step governance transfer
    /// @dev Only callable by the pending governance address
    function acceptGovernanceTimelock() public override(ProtocolAccessControlUpgradeable) { revert BaseModuleSelectorUnavailable(); }

    function cancelGovernanceTimelockTransfer() public override(ProtocolAccessControlUpgradeable) onlyGovernance { revert BaseModuleSelectorUnavailable(); }

    function acceptGovernanceTimelockFromFactory(address expectedGovernanceTimelock) external override { revert BaseModuleSelectorUnavailable(); }

    function cancelGovernanceTimelockFromFactory(address expectedGovernanceTimelock) external override { revert BaseModuleSelectorUnavailable(); }
    ...
    function pause() public override(ISplitRiskPool, ProtocolAccessControlUpgradeable) onlyGovernance { revert BaseModuleSelectorUnavailable(); }
    ...
    function pauseFromFactory() external { revert BaseModuleSelectorUnavailable(); }
    ...
    function unpause() public override(ProtocolAccessControlUpgradeable) onlyGovernance { revert BaseModuleSelectorUnavailable(); }
    ...
    function resetShieldedTokenTransferIntegrity(uint256 probeAmount) external nonReentrant onlyGovernance { revert BaseModuleSelectorUnavailable(); }

    /// @notice Returns whether the pool is currently paused
    function paused() public view override(ISplitRiskPool, PausableUpgradeable) returns (bool) { revert BaseModuleSelectorUnavailable(); }
     ...
     */
    function setAccessControl(address newAccessControl) external { revert BaseModuleSelectorUnavailable(); }
