...
contract BasePoolDepositsModule is Initializable, ISplitRiskPool, ProtocolAccessControlUpgradeable, UUPSUpgradeable {
    ...
    ) external initializer { revert BaseModuleSelectorUnavailable(); }
