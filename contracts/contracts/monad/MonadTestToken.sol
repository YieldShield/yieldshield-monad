...
/// @notice Fixed-supply, valueless Monad testnet demo token. Not a stock, claim, or redeemable dollar.
...
contract MonadTestToken is ERC20 {
    error DemoChainOnly();
        ...
        ERC20(name_, symbol_)
    {
        ...
        if ((decimals_ != 6 && decimals_ != 8 && decimals_ != 18) || initialSupply == 0 || recipient == address(0)) {
